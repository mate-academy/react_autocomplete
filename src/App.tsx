...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const newSuggestion = peopleFromServer.filter(person =>
  ...
  const handleInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSelectedPerson(null); // reset any selected person when starting typing in the input
