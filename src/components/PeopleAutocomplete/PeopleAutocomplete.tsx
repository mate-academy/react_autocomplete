...
export const PeopleAutocomplete: React.FC<Props> = (
  ...
  const refPeopleAutocomplete = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      setShowSuggestions(!(refPeopleAutocomplete.current
        && !refPeopleAutocomplete.current.contains(event.target as Node)));
    };
