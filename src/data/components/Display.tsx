...
export const Display: React.FC<Props> = ({ people, delay, onSelected }) => {
  ...
  const filteredPeople = useMemo(() => {
    const preparedQuery = appliedQuery.toLocaleLowerCase().trim();

    return people.filter(person => (
      person.name.toLocaleLowerCase().includes(preparedQuery)
    ));
  }, [appliedQuery, people]);
