# React Autocomplete
[DEMO LINK](https://artemvlasiuk.github.io/react_autocomplete/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://artemvlasiuk.github.io/react_autocomplete/) and add it to the PR description.
