...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Liliya-Kalinichenko.github.io/react_autocomplete/) and add it to the PR description.
