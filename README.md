...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Yuliia-kucheriavenko.github.io/react_autocomplete/) and add it to the PR description.
