...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vanya-kalyenichenko.github.io/react_autocomplete/) and add it to the PR description.
